				...
				<tr>
					...
					<table border="0" width="100%">
						...
						<tr>
							...
							<td width="6">:</td>
							<td><?php echo $_SESSION['no_kartu_bpjs']; ?></td>
						</tr>
						<tr>
...
?>		
<p					
<font size="2"><b>Silahkan verifikasi kedatangan Di Loket 1 makimal 30 menit sebelum jam periksa dimulai, booking tiket ini tidak berlaku apabila anda datang di atas waktu yang telah di tentukan tersebut</b></font></p>
					<a href="login.php">
