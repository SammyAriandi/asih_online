	...
	<tr>
		...
		<div align="center">			
			<table border="0" width="100%" height="280" bgcolor="#FFFFFF" background="images/bg_login.png" align="center">
				...
				<br><br>
				<a style="color: #000000; text-decoration: underline" href="jkn_get_antrian.php?jenis=BPJS">BPJS KESEHATAN</a>
				<br><br>
				<a href="cetak2.php", style="color: #000000; text-decoration: underline" >Data Antrian Anda</a>
				</font>
				<br>
				</td>
				</tr>						
