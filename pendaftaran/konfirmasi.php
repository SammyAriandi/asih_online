			...
			<table border="0" width="<?php echo $scale; ?>%" height="280" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0">
				<tr>
					...
					&nbsp;<table border="0" width="100%">
						...
						<tr>
							<td width="94">Jam Periksa</td>
							<td width="3">:</td>
							<td><?php echo date('H:i',$_SESSION['jam_nomor']); ?></td>
						</tr>
						<tr>
							<td width="94">No Antrian</td>
							<td width="3">:</td>
					...
					<p><font color="#FF0000">*) Harus sudah konfirmasi 30 menit 
					sebelum jam periksa<br>
					*) Apabila terlambat harus antri dari awal.</font><p><br>
					<a href="pilih_jam.php"><img border="0" src="images/back.png" width="129" height="41"></a>
