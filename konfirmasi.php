...
<div align="center">
&nbsp;</div>
<table border="0" width="100%" height="100%" style="background-position: center top; text-align: center; background-image:url('images/bg_login.png')">
	<tr>
