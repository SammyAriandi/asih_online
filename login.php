				...
				<tr>
					...
					<form method="POST" action="cek_login.php" autocomplete="off">
						...
						<?php	
							...
							if($m=='wrong_id') echo '<b><font color="#FF1010">Akses ditolak<br>Masukkan No RM dengan benar<br></font></b>';
						?>
						
						</font></b>
			<img border="0" src="images/logo.png" width="268" height="148"><b><font size="5"><br>
						
						Selamat Datang</font></b><p align="center">
						Silahkan memasukkan No Rekam Medis
						<br>
					...
					<table border="0" width="100%" cellspacing="0" cellpadding="0">
						<tr>
								...
								<p align="center">
					<br><br>
					<a style="color: #000000; text-decoration: underline" href="pasien_baru.php?jenis=BPJS">Daftar Pasien Baru</a>
				<br><br>
            <font color="#FFFFFF">Untuk Pasien Yang Belum Registrasi Untuk dapat mendaftarkan diri Ke Pendaftaran RS Mitra Idaman  </font><br>
            </p>	
            <p align="center">
                    <br><br>
            <font color="#FFFFFF">Copyright (c) 2021 - 2022 by RS MITRA IDAMAN </font><br>
            </p>
